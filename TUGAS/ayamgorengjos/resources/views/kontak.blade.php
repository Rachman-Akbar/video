                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-white mb-0">Jl. Ayam Goreng Jos No. 123,<br>Jakarta, Indonesia</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="flex-shrink-0">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="mb-0 text-whitex"><a href="mailto:info@ayamgorengjos.com" class="text-white text-decoration-none">info@ayamgorengjos.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
